...
export class ContactValidationError extends ContactError {
  constructor(message: string, code = 'VALIDATION_ERROR', name = 'ContactValidationError') {
...
export class ContactCreationError extends ContactError {
  constructor(message: string, code = 'Contact_CREATION_ERROR', name = 'ContactCreationError') {
...
export class ContactUpdateError extends ContactError {
  constructor(message: string, code = 'Contact_UPDATE_ERROR', name = 'ContactUpdateError') {
    super(message, 500, code);
    this.name = name;
  }
}
...
export class ContactDeletionError extends ContactError {
  constructor(message: string, code = 'Contact_DELETION_ERROR', name = 'ContactDeletionError') {
    super(message, 500, code);
    this.name = name;
  }
}